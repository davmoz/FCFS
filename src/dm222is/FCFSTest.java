...
public class FCFSTest {
	...
	/*
	 * Added this test to test both data and representation of the algorithm result
	 * (table and gantt) when there is no process arriving at time Zero(0) in given
	 * process collection
	 */
	@org.junit.Test
	public void test7() {
		...
		listOfProcesses.add(new Process(1, 2, 18));
		listOfProcesses.add(new Process(2, 3, 2));
		listOfProcesses.add(new Process(3, 25, 5));
		listOfProcesses.add(new Process(4, 29, 2));
		listOfProcesses.add(new Process(5, 33, 7));
		...
		int[] processIds = new int[] { 1, 2, 3, 4, 5 };
		int[] processCT = new int[] { 20, 22, 30, 32, 40 };
		int[] processTAT = new int[] { 18, 19, 5, 3, 7 };
		int[] processWT = new int[] { 0, 17, 0, 1, 0 };
